defmodule RumblWeb.VideoController do
  ...
  @doc """
  This is a function plug. A controller is essentially a plug.
  Phoenix invokes action function by default
  We are replacing the this function because we want to change the API for all our controller actions
  """
